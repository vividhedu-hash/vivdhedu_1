# case_study_builder/page_12_psychometrics.py
...
<div class="grid-4" style="margin-bottom: 2.5mm;">
  <div class="card-subtle" style="border-top: 2.5px solid var(--purple);">
    <div style="font-family: var(--font-mono); font-size: 6pt; font-weight: 700; color: var(--purple);">TIER 1 &middot; DREAM</div>
    <div class="kpi-val" style="font-size: 10pt; margin: 1mm 0;">10% &ndash; 25%</div>
    <div style="font-size: 6.2pt; color: var(--text-muted); line-height: 1.3;">
  ...
  <div class="card-subtle" style="border-top: 2.5px solid var(--accent);">
    <div style="font-family: var(--font-mono); font-size: 6pt; font-weight: 700; color: var(--accent);">TIER 2 &middot; REACH</div>
    <div class="kpi-val" style="font-size: 10pt; margin: 1mm 0;">25% &ndash; 55%</div>
    <div style="font-size: 6.2pt; color: var(--text-muted); line-height: 1.3;">
  ...
  <div class="card-subtle" style="border-top: 2.5px solid var(--green);">
    <div style="font-family: var(--font-mono); font-size: 6pt; font-weight: 700; color: var(--green);">TIER 3 &middot; TARGET</div>
    <div class="kpi-val" style="font-size: 10pt; margin: 1mm 0;">55% &ndash; 85%</div>
    <div style="font-size: 6.2pt; color: var(--text-muted); line-height: 1.3;">
  ...
  <div class="card-subtle" style="border-top: 2.5px solid #64748B;">
    <div style="font-family: var(--font-mono); font-size: 6pt; font-weight: 700; color: #64748B);">TIER 4 &middot; SAFETY</div>
    <div class="kpi-val" style="font-size: 10pt; margin: 1mm 0;">&gt; 85%</div>
    <div style="font-size: 6.2pt; color: var(--text-muted); line-height: 1.3;">
...
<div class="card-accent" style="margin-bottom: 0;">
  ...
  <div style="font-size: 7.2pt; color: var(--text-main); line-height: 1.4;">
    Traditional consultancies push students to apply to 20+ institutions at enormous application fee costs (&pound;2,000+). 
...
"""
    return wrap_page(content, 12, 20, "Adaptive Psychometrics &amp; Portfolio Math", "PART IV &middot; THE QUANTITATIVE CORE")
