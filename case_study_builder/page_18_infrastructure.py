# case_study_builder/page_18_infrastructure.py
...
"""
    return wrap_page(content, 18, 20, "Enterprise Infrastructure &amp; Ingestion Mesh", "PART VIII &middot; SYSTEM ARCHITECTURE")
