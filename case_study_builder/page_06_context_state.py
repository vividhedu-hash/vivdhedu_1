# case_study_builder/page_06_context_state.py
...
<div class="headline-sub">Why sovereign longitudinal state is the defining moat of Student OS.</div>
  ...
  <div>
    <div class="card-accent" style="height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
      <div>
        ...
        <p class="body-p" style="color: var(--text-main); font-size: 7.2pt; line-height: 1.45;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5mm; margin-top: 2mm;">
          <div style="font-family: var(--font-mono); font-size: 6pt; background: #FFFFFF; padding: 2px 5px; border-radius: 2px; border: 0.5pt solid #BFDBFE;">
          ...
          <div style="font-family: var(--font-mono); font-size: 6pt; background: #FFFFFF; padding: 2px 5px; border-radius: 2px; border: 0.5pt solid #BFDBFE;">
            &bull; <strong>Recent Waves:</strong> Filters 1,000s of feeds to 4 high-match cards
          </div>
          <div style="font-family: var(--font-mono); font-size: 6pt; background: #FFFFFF; padding: 2px 5px; border-radius: 2px; border: 0.5pt solid #BFDBFE;">
            &bull; <strong>Counselling:</strong> Human advisors see live verified telemetry
          </div>
        </div>
      </div>
      
      <div style="font-family: var(--font-mono); font-size: 5.5pt; color: var(--accent-dark); margin-top: 2mm; border-top: 0.5pt solid #BFDBFE; padding-top: 1mm;">
        SECURITY: AES-256 GCM &middot; ZERO LEAKAGE &middot; NO COMMERCIAL AD RESELLING
      </div>
    </div>
  </div>
</div>
"""
    return wrap_page(content, 6, 20, "The Persistent Student Context State Machine", "PART II &middot; CONCEPTUAL ARCHITECTURE")
