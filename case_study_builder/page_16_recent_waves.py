# case_study_builder/page_16_recent_waves.py
...
"""
    return wrap_page(content, 16, 20, "Recent Waves &middot; Dynamic Profile Telemetry", "PART VI &middot; LONGITUDINAL TELEMETRY")
