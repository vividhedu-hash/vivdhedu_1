# case_study_builder/page_11_actuarial_math.py
...
"""
    return wrap_page(content, 11, 26, "Student Asset Pricing &amp; Actuarial Models", "PART IV &middot; THE QUANTITATIVE CORE")
