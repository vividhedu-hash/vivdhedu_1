# case_study_builder/page_14_ai_interface.py
...
<div class="grid-3" style="margin-bottom: 0;">
  ...
  <div class="card-subtle">
    <div class="card-title-sm">3. Direct Action Hooks</div>
    <p class="body-p" style="font-size: 6.8pt; line-height: 1.35; margin-bottom: 0;">
      <strong>`[+ Add to Roadmap]` &amp; `[Explore Test Prep Labs]`.</strong> The decision terminates in direct operating system actions. 
      Clicking &ldquo;Add to Roadmap&rdquo; immediately inserts SAT diagnostic sprints into Alex's calendar, adjusting milestone velocities.
    </p>
  </div>
</div>
"""
    return wrap_page(content, 14, 20, "The Decision Interface in Operation", "PART V &middot; THE ORCHESTRATION LAYER")
