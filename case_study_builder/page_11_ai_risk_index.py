# case_study_builder/page_11_ai_risk_index.py
from styles import wrap_page

def get_page_11():
    content = """
<div class="kicker">Part IV &middot; The Quantitative Core</div>
<h1 class="headline">The Flagship AI Risk Index</h1>
...
<div class="grid-2" style="margin-bottom: 0;">
  <div class="card-subtle">
    ...
    <p class="body-p" style="font-size: 7pt; line-height: 1.4; margin-bottom: 0;">
      ...
      Programs heavy in $V_1&ndash;V_3$ (generic coding) drop below 35 by 2028, whereas hybrid tracks (Quantitative Economics with $V_5, V_8$) maintain JSS &gt; 80.
    </p>
  </div>
...
"""
    return wrap_page(content, 11, 20, "The Flagship AI Risk &amp; Labor Demand Index", "PART IV &middot; THE QUANTITATIVE CORE")
